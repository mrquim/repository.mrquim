...
class DIALOG:
    def start(self, xml_file, labels={}, buttons=[], list=0):
        
        display = SHOW(xml_file, __addonpath__, labels=labels,  buttons=buttons, list=list)
...
class SHOW(xbmcgui.WindowXMLDialog):
    ...
    def __init__(self, xmlFile, resourcePath, labels, buttons, list):
