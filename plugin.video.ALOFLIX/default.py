...
addon = xbmcaddon.Addon('plugin.video.ALOFLIX')
...
SOURCES = [{"description": ": PELICULAS EN SD Y HD EN AUDIO LATINO :", "title": "ALOFLIX ", "url": "http://pastebin.com/raw/0e0jxUNX", "fanart": "http://s15.postimg.org/vz8exk7re/12511294_10156368855525332_63585561_o.jpg", "genre": "movies", "date": "1.02.2016", "credits": "Jaleman", "thumbnail": "http://s24.postimg.org/t88nwvzut/12306029_10153131942002484_372138610_n.jpg"}]

# http://s15.postimg.org/vz8exk7re/12511294_10156368855525332_63585561_o.jpg
# http://s24.postimg.org/t88nwvzut/12306029_10153131942002484_372138610_n.jpg
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.ALOFLIX-%s]: %s" %(addon_version, string))
...
def makeRequest(url, headers=None):
        try:
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.Notification(vikings,We failed with error code - "+str(e.code)+",10000,"+icon+")")
            elif hasattr(e, 'reason'):
                addon_log('We failed to reach a server.')
                addon_log('Reason: %s' %e.reason)
                xbmc.executebuiltin("XBMC.Notification(vikings,We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")
